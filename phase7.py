...
time_lbl = Label(second, text="File created successfully", fg = 'dodger blue', font=("Helvetica", 10, "bold") )
time_lbl.grid(row=4, column=5) 

#mail_avail = IntVar()
#mail_avail = xerox_available
if xerox_available == 0:
    time_lbl.configure(text="No Xerox Mail. File is not created!", fg = 'red', font=("Helvetica", 8, "italic"))
